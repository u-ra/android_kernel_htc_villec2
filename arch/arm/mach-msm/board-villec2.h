...
#define MSM_PMEM_SF_SIZE 0x00000000 /* 0 Mbytes */
#else
...
#define VILLEC2_GPIO_CAPTURE_MODE_KEY       (131) // NC
...
#define VILLEC2_AUD_2V85_EN        PMGPIO(34) // AudioJack Mic
#define VILLEC2_AUD_UART_OE        PMGPIO(20) // Audio UART Output
...
#define VILLEC2_SDC3_DET           PMGPIO(35) // NC
