...
static struct clk_lookup msm_clocks_8x60[] = {
	...
	//HTC_START Jason Huang 201205xx --- iommu driver may turn on this clock by dev_id "msm_iommu" and con_id "iface_clk". Sync from the latest 8x60 code-base.
	...
	//HTC_START Jason Huang 201205xx --- iommu driver may turn on the clocks below for each SMMU instance. Sync from the latest 8x60 code-base.
	/*
